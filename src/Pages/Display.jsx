...
export default function Display({ folderName, files}){
    ...
    return(
        <div className='display'>
            ...
            <div className="display-wrapper" style={{width:!isGrid && '100%'}}>
                    { isGrid ? <Cards files={files}/> : <Table files={files}/>}
            </div>
        </div>
    )
}
        ...
        return (
            <div className="files-card">
                ...
                <div className="card-bottom">
                    ...
                    <div className='content'>{item.title ?? item.name}</div>
